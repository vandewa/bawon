                ...
                <div class="mb-3 card card-primary">
                    ...
                    <div class="p-3 card-body">
                        ...
                        <fieldset class="p-3 mb-4 border rounded">
                            ...
                            {{-- Tampilkan foto yang sedang diunggah (belum disimpan) --}}
                            @if ($foto_vendor)
                                <div class="row mt-3">
                                    @foreach ($foto_vendor as $index => $preview)
                                        <div class="col-md-3 mb-3" style="position: relative;">
                                            ...
                                            <button type="button" wire:click="removeFotoVendor({{ $index }})"
                                                style="position: absolute; top: 5px; right: 5px; z-index: 10; background: rgba(255, 0, 0, 0.8); color: white; border: none; border-radius: 50%; width: 24px; height: 24px; line-height: 20px; text-align: center; font-size: 14px; cursor: pointer;">
                                                &times;
                                            </button>
                                        </div>
                                    @endforeach
                            ...
                            {{-- Tampilkan foto vendor yang sudah tersimpan --}}
                            @if (isset($vendor['id']))
                                <div class="row mt-3">
                                    @foreach (\App\Models\VendorPhoto::where('vendor_id', $vendor['id'])->get() as $photo)
                                        <div class="col-md-3 mb-3 position-relative">
                                            <img src="{{ Storage::url($photo->photo_path) }}" class="img-thumbnail"
                                                style="width: 100%;">
                                            {{-- Tombol hapus foto lama opsional bisa ditambahkan di sini --}}
                                        </div>
                                    @endforeach
                                </div>
                            @endif
