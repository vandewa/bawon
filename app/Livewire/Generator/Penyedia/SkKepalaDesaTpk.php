...
class SkKepalaDesaTpk extends Component
{
    ...
    public function mount()
    {
        $this->isiSurat = <<<HTML
            ...
            <span style="font-size:8pt;"><i>
            **) jumlah keanggotaan TPK gasal yang disesuaikan dengan kompleksitas pekerjaan dan berasal dari 
            perwakilan perangkat desa, lembaga kemasyarakatan desa, dan/atau masyarakat. </i>
            </span>
    ...
    {
        return view('livewire.generator.penyedia.sk-kepala-desa-tpk');
    }
}
