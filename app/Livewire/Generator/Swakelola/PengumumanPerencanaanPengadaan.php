...
class PengumumanPerencanaanPengadaan extends Component
{
        ...
        $this->isiSurat = <<<HTML
            <div style="font-family:Arial; font-size:10pt;">
                ...
                <table border="1" style="width:100%; font-size:10pt; font-family:Arial; border-collapse:collapse; margin:0; padding:0;">
                    ...
                    <tbody>
                        <tr>
                            <td style="font-size:8pt;text-align:center;"><i>a</i></td>
                            <td style="font-size:8pt;text-align:center;"><i>b</i></td>
                            <td style="font-size:8pt;text-align:center;"><i>c</i></td>
                            <td style="font-size:8pt;text-align:center;"><i>d</i></td>
                            <td style="font-size:8pt;text-align:center;"><i>e</i></td>
                            <td style="font-size:8pt;text-align:center;"><i>f</i></td>
                            <td style="font-size:8pt;text-align:center;"><i>g</i></td>
                            <td style="font-size:8pt;text-align:center;"><i>h</i></td>
                            <td style="font-size:8pt;text-align:center;"><i>i</i></td>
                        </tr>
                        <tr>
                ...
                <table class="no-border" style="width:100%; font-family:Arial; font-size:10pt;">
                    <tr>
                        ...
                        <td>
                            ...
                            <span style="font-weight:bold;">Kepala Desa </span><br><br>
    ...
    {
        return view('livewire.generator.swakelola.pengumuman-perencanaan-pengadaan');
    }
}
