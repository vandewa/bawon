...
Route::middleware([
    ...
    Route::group(['prefix' => 'desa', 'as' => 'desa.',
        ...
        Route::get('desa-index', DesaCreate::class)
            ->middleware(['auth', 'role:superadministrator|dinsos|desa']) // hanya admin/dinsos
            ->name('desa-create');

        Route::get('desa-index', DesaIndex::class)->name('desa-index')->middleware('role:superadministrator|dinsos|desa');
